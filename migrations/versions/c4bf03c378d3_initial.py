...
Revision ID: c4bf03c378d3
Revises: 
Create Date: 2025-12-04 01:32:56.931509
...
def upgrade():
    ...
    sa.Column('number_of_csv', sa.String(length=120), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('publication_type', sa.Enum('NONE', 'BEER_RECOMENDATION', 'BEER_INFORMATION', 'BEER_DOCUMENTATION', 'BEER_BRANCHES', 'OTHER', name='publicationtype'), nullable=False),
    ...
    sa.Column('twofa_confirmed', sa.Boolean(), nullable=True),
    ...
    sa.Column('csv_model_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['csv_model_id'], ['csv_model.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
